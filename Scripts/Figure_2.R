...
Covids_66 <- boxplot_covid
Influenzas_66 <- boxplot_influenza
Figure1_66<- covid_ggplot + influenza_ggplot
Figure1_66

###STOP HERE TO CHECK VALUES FOR THE UPPER PANEL### OR Check Dataframes: Covids_66 and Influenzas_66
...
Covids_75 <- boxplot_covid
Influenzas_75 <- boxplot_influenza
Figure1_75<- covid_ggplot + influenza_ggplot

Figure2 <- Figure1_66 / Figure1_75 #THIS GIVES FIGURE 2
Figure2

#ggsave("240929_Figure2.jpeg")

###STOP HERE TO CHECK VALUES FOR THE UPPER PANEL### OR Check Dataframes: Covids_75 and Influenzas_75
mean(ancestral_boxplot_n$R)
quantile(ancestral_boxplot_n$R)
mean(ancestral_boxplot_sw$R)
quantile(ancestral_boxplot_sw$R)
...
#Influenzas_66
#Influenzas_75
#The above dataframes contain the numerical results for Figure 2.
